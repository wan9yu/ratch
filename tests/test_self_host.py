...
load_manifest read at this repo's own root must return the sixteen ids in
...
def load_manifest_should_return_all_sixteen_teeth_when_read_from_the_ratch_repo_root():
